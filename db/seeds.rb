...
disel=Person.create(:name=>"Вин Дизель", :origin_name=>"Vin Disel", :birthday=>Date.parse("18.07.1967"), :male=>false)
ritchie=Person.create(:name=>"Гай Ричи", :origin_name=>"Guy Ritchie", :birthday=>Date.parse("10.09.1968"), :male=>false)
statham=Person.create(:name=>"Джейсон Стэтхэм", :origin_name=>"Jason Statham", :birthday=>Date.parse("12.09.1967"), :male=>false)
pattinson=Person.create(:name=>"Роберт Паттинсон", :origin_name=>"Robert Pattinson", :birthday=>Date.parse("12.05.1986"), :male=>false)
arterton=Person.create(:name=>"Джемма Артертон", :origin_name=>"Gemma Arterton", :birthday=>Date.parse("12.01.1986"), :male=>true)
gyllenhaal=Person.create(:name=>"Джейк Джилленхол", :origin_name=>"Jake Gyllenhaal", :birthday=>Date.parse("19.12.1980"), :male=>false)
svetlakov=Person.create(:name=>"Сергей Светлаков", :origin_name=>"", :birthday=>Date.parse("12.12.1977"), :male=>false)
galustayn=Person.create(:name=>"Милла Йовович", :origin_name=>"Milla Jovovich", :birthday=>Date.parse("17.12.1975"), :male=>true)
larter=Person.create(:name=>"Эли Лартер", :origin_name=>"Ali Larter", :birthday=>Date.parse("28.02.1976"), :male=>true)
chan=Person.create(:name=>"Джеки Чан", :origin_name=>"Jackie Chan", :birthday=>Date.parse("07.04.1954"), :male=>false)
lundgren=Person.create(:name=>"Дольф Лундгрен", :origin_name=>"Dolph Lundgren", :birthday=>Date.parse("03.11.1957"), :male=>false)
stallone=Person.create(:name=>"Сильвестер Сталлоне", :origin_name=>"Sylvester Stallone", :birthday=>Date.parse("06.07.1946"), :male=>false)
depardieu=Person.create(:name=>"Жерар Депардье", :origin_name=>"Gerard Depardieu", :birthday=>Date.parse("27.12.1948"), :male=>false)
rourke=Person.create(:name=>"Микки Рурк", :origin_name=>"Mickey Rourke", :birthday=>Date.parse("16.09.1952"), :male=>false)
clooney=Person.create(:name=>"Джордж Клуни", :origin_name=>"George Clooney", :birthday=>Date.parse("06.05.1961"), :male=>false)
pitt=Person.create(:name=>"Брэд Питт", :origin_name=>"Brad Pitt", :birthday=>Date.parse("18.12.1963"), :male=>false)
roberts=Person.create(:name=>"Джулия Робертс", :origin_name=>"Julia Roberts", :birthday=>Date.parse("28.10.1967"), :male=>true)
depp=Person.create(:name=>"Джонни Депп", :origin_name=>"Johnny Depp", :birthday=>Date.parse("09.06.1963"), :male=>false)
bloom=Person.create(:name=>"Орландо Блум", :origin_name=>"Orlando Bloom", :birthday=>Date.parse("13.01.1977"), :male=>false)
gor=Person.create(:name=>"Гор Вербински", :origin_name=>"Gore Verbinski", :birthday=>Date.parse("16.03.1964"), :male=>false)
cannon=Person.create(:name=>"Дэнни Кэннон", :origin_name=>"Danny Cannon", :birthday=>Date.parse("16.03.1968"), :male=>false)
guerra=Person.create(:name=>"Леонардо Гуерра", :origin_name=>"Leonardo Guerra", :birthday=>Date.parse("10.08.1985"), :male=>false)
